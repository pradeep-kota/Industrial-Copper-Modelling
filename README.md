...
streamlit theme setting in .toml file
```python 
[theme]
base="dark"
primaryColor="#FF4B4B"
...
Get required libraries for this project in requirements.txt file attached.

***Refer to the project details more in the file attached as "Industrial Copper Modelling" or below***
